...
class AchievementSystem:
    ...
    def __init__(self, db_lock):
        ...
        self.achievements_config = {
            ...
            "first_room": {
                "name": "Creador Novato",
                "description": "Crea tu primera sala",
                "xp_reward": 25,
                "icon": "🏠",
                "category": "primeras_veces",
            ...
            "first_ability": {
                "name": "Primer Poder",
                "description": "Usa tu primera habilidad",
                "xp_reward": 30,
                "icon": "⚡",
                "category": "primeras_veces",
            ...
            # Logros de Juego
            "speed_demon": {
                "name": "Demonio Velocista",
                "description": "Gana una partida en menos de 15 movimientos",
                "xp_reward": 200,
                "icon": "🚀",
                "category": "gameplay",
                "trigger": "game_finished",
                "target_value": 1,
            },  # Es ganar 1 partida así
            "survivor": {
                "name": "Superviviente",
                "description": "Gana con menos de 50 de energía",
                "xp_reward": 150,
                "icon": "🩹",
                "category": "gameplay",
                "trigger": "game_finished",
            ...
            "energy_master": {
                ...
                "description": "Termina una partida con más de 1000 de energía",
                "xp_reward": 125,
                "icon": "⚡",
                "category": "gameplay",
                "trigger": "game_finished",
                "target_value": 1,
            },  # Es terminar 1 partida así
            "ability_master": {
                "name": "Maestro de Habilidades",
                "description": "Usa las 4 habilidades en una partida",
                "xp_reward": 175,
                "icon": "🎯",
                "category": "gameplay",
                "trigger": "game_finished",
            ...
            "comeback_king": {
                ...
                "description": "Gana estando en último lugar a mitad de partida",
                "xp_reward": 250,
                "icon": "👑",
                "category": "gameplay",
                "trigger": "game_finished",
            ...
            "chat_king": {
                "name": "Rey del Chat",
                "description": "Envía 25 mensajes en una sola partida",
                "xp_reward": 50,
                "icon": "💬",
                "category": "social",
                "trigger": "game_finished",
                "target_value": 25,
            },  # Requiere trackeo por partida
            "room_host": {
                "name": "Anfitrión Experto",
                "description": "Crea 10 salas",
                "xp_reward": 100,
                "icon": "🏠",
                "category": "social",
                "trigger": "room_created",
            ...
            "chat_master": {
                ...
                "description": "Envía 50 mensajes privados",
                "xp_reward": 200,
                "icon": "💬",
                "category": "social",
                "trigger": "private_message_sent",
                "target_value": 50,
            },
            # Logros de Suerte
            "lucky_seven": {
                "name": "Siete de la Suerte",
                "description": "Saca 6 en el dado 3 veces seguidas",
                "xp_reward": 300,
                "icon": "🍀",
                "category": "luck",
                "trigger": "dice_rolled",
            ...
            "treasure_hunter": {
                "name": "Cazatesoros",
                "description": "Cae en 5 casillas de tesoro en una partida",
                "xp_reward": 150,
                "icon": "💰",
                "category": "luck",
                "trigger": "game_finished",
            ...
            "trap_avoider": {
                "name": "Esquiva Trampas",
                "description": "Completa una partida sin caer en ninguna trampa",
                "xp_reward": 100,
                "icon": "🛡️",
                "category": "luck",
                "trigger": "game_finished",
            ...
            "superviviente": {
                "name": "Superviviente",
                "description": "Terminar el juego sin ser eliminado",
                "xp_reward": 200,
                "icon": "💪",
                "category": "survival",
                "trigger": "game_finished",
            ...
            "meta_alcanzada": {
                "name": "¡Meta Alcanzada!",
                "description": "Llegar a la casilla 75",
                "xp_reward": 300,
                "icon": "🏁",
            ...
            "explosion_perfecta": {
                "name": "Explosión Perfecta",
                "description": "Afectar a 2 o más jugadores con Bomba Energética",
                "xp_reward": 250,
                "icon": "💥",
                "category": "combat",
                "trigger": "ability_used",
            ...
            "reflejo_maestro": {
                "name": "Reflejo Maestro",
                "description": "Reflejar un ataque con Barrera",
                "xp_reward": 200,
                "icon": "🔁",
                "category": "defense",
                "trigger": "ability_used",
            ...
            "muralla_humana": {
                "name": "Muralla Humana",
                "description": "Sobrevivir a una colisión con escudo activo",
                "xp_reward": 175,
                "icon": "🛡️",
                "category": "defense",
                "trigger": "collision",
            ...
            "fantasma": {
                "name": "Fantasma",
                "description": "Evitar un ataque estando invisible",
                "xp_reward": 150,
                "icon": "👻",
                "category": "stealth",
                "trigger": "ability_defense",
                "target_value": 1,
            },
            "regenerador": {
                "name": "Regenerador",
                "description": "Recuperar energía con Curación desde menos de 200 puntos",
                "xp_reward": 175,
                "icon": "💚",
                "category": "recovery",
                "trigger": "ability_used",
            ...
            "ultimo_en_pie": {
                "name": "Último en Pie",
                "description": "Ser el único jugador activo al final de la partida",
                "xp_reward": 500,
                "icon": "👑",
                "category": "domination",
                "trigger": "game_finished",
            ...
            "viajero_dimensional": {
                ...
                "description": "Activar 5 casillas especiales distintas en una misma partida",
                "xp_reward": 225,
                "icon": "🌀",
            ...
            "energizado": {
                "name": "Energizado",
                "description": "Alcanzar más de 1000 puntos de energía",
                "xp_reward": 200,
                "icon": "⚡",
                "category": "power",
                "trigger": "game_finished",
            ...
            "cazador_de_packs": {
                "name": "Cazador de Packs",
                "description": "Obtener 10 o más packs de energía en una partida",
                "xp_reward": 225,
                "icon": "🎒",
                "category": "collection",
                "trigger": "game_finished",
            ...
            "inmortal": {
                "name": "Inmortal",
                "description": "Recuperarse tras llegar a 0 energía",
                "xp_reward": 400,
                "icon": "🔥",
                "category": "comeback",
                "trigger": "game_event",
            ...
            "el_caotico": {
                "name": "El Caótico",
                "description": "Usar Caos cuando todos los jugadores están cerca de la meta",
                "xp_reward": 300,
                "icon": "🎪",
                "category": "chaos",
                "trigger": "ability_used",
            ...
            "equilibrio_cosmico": {
                ...
                "description": "Terminar el juego con exactamente 600 puntos de energía",
                "xp_reward": 350,
                "icon": "⚖️",
                "category": "precision",
                "trigger": "game_finished",
            ...
            "coleccionista": {
                "name": "Coleccionista",
                "description": "Desbloquear 10 logros diferentes",
                "xp_reward": 500,
                "icon": "📚",
                "category": "meta",
            ...
            "perfeccionista": {
                "name": "Perfeccionista",
                "description": "Ganar sin usar ninguna habilidad",
                "xp_reward": 300,
                "icon": "✨",
                "category": "challenge",
                "trigger": "game_finished",
            ...
            "estratega_supremo": {
                ...
                "trigger": "game_finished",
                "target_value": 3,
            },  # Requiere trackeo externo
            "maratonista": {
                "name": "Maratonista",
                "description": "Completar una partida que dure más de 50 rondas",
                "xp_reward": 150,
                "icon": "🏃‍♂️",
                "category": "endurance",
                "trigger": "game_finished",
            ...
            "precision_laser": {
                ...
                "description": "Usar la habilidad 'Dado Perfecto' 3 veces en una sola partida",
                "xp_reward": 175,
                "icon": "🎯",
                "category": "precision",
                "trigger": "game_finished",
    ...
    def check_achievement(self, username, event_type, event_data=None, user_obj=None):
        with self.db_lock:
            ...
            if user_obj:
                ...
                user = (
                    User.query.options(
                        selectinload(User.unlocked_achievements_assoc).selectinload(
            ...
            if not user:
                logger.warning(
                    f"ACHIEVEMENT ERROR: Usuario {username} no encontrado. No se verificaron logros."
                )
                return []

            # Obtener IDs de logros ya desbloqueados
            unlocked_ach_ids = [
                ua.achievement.internal_id for ua in user.unlocked_achievements_assoc
            ]
            ...
            if event_type == "game_finished":
                newly_unlocked_ids.extend(
                    self._check_game_finished_achievements(
                        username, event_data, unlocked_ach_ids, user_stats
                    )
                )

            elif event_type == "ability_used":
                newly_unlocked_ids.extend(
                    self._check_ability_achievements(
                        username, event_data, unlocked_ach_ids, user_stats
                    )
                )
                ...
                newly_unlocked_ids.extend(
                    self._check_room_achievements(
                        username, unlocked_ach_ids, user_stats
                    )
                )

            elif event_type == "dice_rolled":
                newly_unlocked_ids.extend(
                    self._check_dice_achievements(
                        username, event_data, unlocked_ach_ids, user_stats
                    )
                )
                ...
                newly_unlocked_ids.extend(
                    self._check_special_tile_achievements(
                        username, event_data, unlocked_ach_ids, user_stats
                    )
                )
                ...
                newly_unlocked_ids.extend(
                    self._check_game_event_achievements(
                        username, event_data, unlocked_ach_ids, user_stats
                    )
                )
                ...
                newly_unlocked_ids.extend(
                    self._check_login_achievements(
                        username, event_data, unlocked_ach_ids, user_stats
                    )
                )
            ...
            # Añadimos los nuevos triggers sociales
                ...
                newly_unlocked_ids.extend(
                    self._check_social_achievements(
                        username, event_type, unlocked_ach_ids, user_stats
                    )
                )
            ...
            newly_unlocked_ids.extend(
                self._check_persistence_achievements(
                    username, unlocked_ach_ids, user_stats
                )
            )
            ...
            achievements_to_unlock = Achievement.query.filter(
                Achievement.internal_id.in_(final_unlocks)
            ).all()

            for achievement_obj in achievements_to_unlock:
                # Verificar UNA ÚLTIMA VEZ que el logro no esté ya en la tabla de asociación
                is_already_unlocked = UserAchievement.query.filter_by(
                    user_id=user.id, achievement_id=achievement_obj.id
                ).first()
    ...
    def _check_game_finished_achievements(
        self, username, event_data, current_achievements, user_stats
    ):
        unlocked = []
        ...
        # Primera victoria
        if (
            "first_win" not in current_achievements
            and event_data.get("won")
            and user_stats["games_won"] >= 1
        ):
            unlocked.append("first_win")

        # Demonio velocista
        if (
            "speed_demon" not in current_achievements
            and event_data.get("won")
            and event_data.get("total_rounds", 99) < 15
        ):
            unlocked.append("speed_demon")

        # Superviviente original (ganar con poca energía)
        if (
            "survivor" not in current_achievements
            and event_data.get("won")
            and event_data.get("final_energy", 1000) < 50
        ):
            unlocked.append("survivor")

        # Superviviente (terminar sin ser eliminado)
        if "superviviente" not in current_achievements and event_data.get(
            "never_eliminated", True
        ):
            unlocked.append("superviviente")

        # Meta Alcanzada (llegar a casilla 75)
        if (
            "meta_alcanzada" not in current_achievements
            and event_data.get("reached_position", 0) >= 75
        ):
        ...
        if (
            "equilibrio_cosmico" not in current_achievements
            and event_data.get("final_energy", 0) == 600
        ):
            unlocked.append("equilibrio_cosmico")

        # Último en Pie (único jugador activo)
        if "ultimo_en_pie" not in current_achievements and event_data.get(
        ...
        if (
            "cazador_de_packs" not in current_achievements
            and event_data.get("energy_packs_collected", 0) >= 10
        ):
            unlocked.append("cazador_de_packs")

        # Viajero Dimensional (5 casillas especiales distintas)
        if (
            "viajero_dimensional" not in current_achievements
            and len(event_data.get("special_tiles_activated", set())) >= 5
        ):
            unlocked.append("viajero_dimensional")

        # Perfeccionista (ganar sin usar habilidades)
        if (
            "perfeccionista" not in current_achievements
            and event_data.get("won")
            and event_data.get("abilities_used", 1) == 0
        ):
            unlocked.append("perfeccionista")

        # Maratonista (más de 50 rondas)
        if (
            "maratonista" not in current_achievements
            and event_data.get("total_rounds", 0) > 50
        ):
            unlocked.append("maratonista")

        # Maestro de habilidades (Usa 4 o más habilidades)
        if (
            "ability_master" not in current_achievements
            and event_data.get("abilities_used", 0) >= 4
        ):
            unlocked.append("ability_master")

        # Cazatesoros (Cae en 5+ tesoros)
        if (
            "treasure_hunter" not in current_achievements
            and event_data.get("treasures_this_game", 0) >= 5
        ):
            unlocked.append("treasure_hunter")

        # Precisión Láser (Usa Dado Perfecto 3+ veces)
        if (
            "precision_laser" not in current_achievements
            and event_data.get("precision_laser", 0) >= 3
        ):
            unlocked.append("precision_laser")

        # Esquiva Trampas (Completa sin caer en trampas)
        if "trap_avoider" not in current_achievements and event_data.get(
        ...
        if (
            "chat_king" not in current_achievements
            and event_data.get("messages_this_game", 0) >= 25
        ):
        ...
        if (
            "coleccionista" not in current_achievements
            and current_total_achievements >= 10
        ):
            unlocked.append("coleccionista")

        return unlocked

    def _check_ability_achievements(
        self, username, event_data, current_achievements, user_stats
    ):
        unlocked = []
        ...
        # Primera habilidad
        if (
            "first_ability" not in current_achievements
            and user_stats["abilities_used"] >= 1
        ):
        ...
        if habilidad_usada == "Bomba Energética":
            ...
            if (
                "explosion_perfecta" not in current_achievements
                and afectados_count >= 2
            ):
        ...
        if habilidad_usada == "Caos":
            if (
                event_data.get("caos_cerca_meta")
                and "el_caotico" not in current_achievements
            ):
    ...
    def _check_room_achievements(self, username, current_achievements, user_stats):
        ...
        # Primera sala
        if (
            "first_room" not in current_achievements
            and user_stats["rooms_created"] >= 1
        ):
            unlocked.append("first_room")

        # Anfitrión experto
        if (
            "room_host" not in current_achievements
            and user_stats["rooms_created"] >= 10
        ):
            unlocked.append("room_host")

        return unlocked

    def _check_chat_achievements(
        self, username, event_data, current_achievements, user_stats
    ):
        unlocked = []
        event_data = event_data or {}
    ...
    def _check_special_tile_achievements(
        self, username, event_data, current_achievements, user_stats
    ):
        unlocked = []
        ...
        if "trap_avoider" not in current_achievements and event_data.get(
            "completed_without_traps"
        ):
            unlocked.append("trap_avoider")

        return unlocked

    def _check_persistence_achievements(
        self, username, current_achievements, user_stats
    ):
        unlocked = []
    ...
    def _check_game_event_achievements(
        self, username, event_data, current_achievements, user_stats
    ):
        unlocked = []
        ...
        if (
            ...
            and "muralla_humana" not in current_achievements
        ):
    ...
    def get_achievement_info(
        self, achievement_id, current_user_stats=None, unlocked_ids_set=None
    ):
        ...
        if unlocked_ids_set and achievement_id in unlocked_ids_set:
            info["unlocked"] = True
            info["current_value"] = info[
                "target_value"
            ]  # Si está desbloqueado, el progreso es 100%
            ...
            # Logros de "primera vez" (target 1)
                ...
                info["current_value"] = (
                    1 if current_user_stats.get("games_played", 0) >= 1 else 0
                )
            elif achievement_id == "first_win":
                info["current_value"] = (
                    1 if current_user_stats.get("games_won", 0) >= 1 else 0
                )
            elif achievement_id == "first_room":
                info["current_value"] = (
                    1 if current_user_stats.get("rooms_created", 0) >= 1 else 0
                )
            elif achievement_id == "first_ability":
                info["current_value"] = (
                    1 if current_user_stats.get("abilities_used", 0) >= 1 else 0
                )

            # Logros de partida única (target > 1, pero progreso se resetea cada partida)
            elif achievement_id in [
                "treasure_hunter",
                "viajero_dimensional",
                "cazador_de_packs",
                "precision_laser",
                ...
                info["current_value"] = (
                    0  # Progreso solo visible durante la partida (requiere más lógica)
                )
    ...
    def get_user_achievement_progress(self, username):
        ...
        unlocked_map = {
            ua.achievement.internal_id: ua.unlocked_at for ua in unlocked_assoc
        }
        ...
        for ach_id, ach_config in all_achievements_config.items():
            ...
            achievement_data = {
                ...
                "unlocked_at": (
                    unlocked_map.get(ach_id).isoformat()
                    if is_unlocked and unlocked_map.get(ach_id)
                    else None
                ),
        ...
        return {
            ...
            "percentage": (
                (len(unlocked_ids_set) / len(all_achievements_config)) * 100
                if len(all_achievements_config) > 0
                else 0
            ),
            "achievements": progress_list,  # La lista detallada
        }

    def _check_social_achievements(
        self, username, event_type, current_achievements, user_stats
    ):
        unlocked = []
